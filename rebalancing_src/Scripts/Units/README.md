Only files that have been changed are included. Other scripts are the same as in original Earth2160_SDK. You can take them from SDK if you'd like to update them.
